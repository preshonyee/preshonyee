...
## Shaping how people build products with AI @ [Kickserve](https://kickserve.build/).
...
## Current projects
- [Kickserve](https://kickserve.build/) - The AI coding platform that thinks like a founder
